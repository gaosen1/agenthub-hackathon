...
>
> 完整设计文档：`/home/dev/.qoder/plans/bold-wilderness-bream.md`（若不可读，本文件信息已足够自持）
> 工作目录：`/home/dev/.qoder/worktree/team-055/ESFm4T`（**git worktree，不要 cd 回主仓**）
...
| `handoffs/devuser/…` | key 用的是**数字** user_id：`handoffs/1/…` |
